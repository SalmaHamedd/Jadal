...
/// and the coach's name on its own line. Tap stays a no-op — there is no
/// team-detail screen in the app yet.
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(Icons.group_rounded,
                                size: 12, color: JadalColors.primaryBlue),
                            const SizedBox(width: 3),
                            Text(
                              context.loc.membersCountLabel(team.membersCount),
                              style: TextStyle(
                                fontFamily: 'Cairo',
